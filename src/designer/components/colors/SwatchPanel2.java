...
public class SwatchPanel2 extends JPanel {
			...
			public void keyPressed(KeyEvent e) {
				...
				switch (typed) {
					...
					case KeyEvent.VK_LEFT:
						if (selCol > 0 && SwatchPanel2.this.getComponentOrientation().isLeftToRight()) {
							selCol--;
							repaint();
						} else if (selCol < numSwatches.width - 1
								&& !SwatchPanel2.this.getComponentOrientation().isLeftToRight()) {
							selCol++;
							repaint();
						}
						break;
					case KeyEvent.VK_RIGHT:
						if (selCol < numSwatches.width - 1
							...
							selCol++;
							repaint();
						} else if (selCol > 0 && !SwatchPanel2.this.getComponentOrientation().isLeftToRight()) {
							selCol--;
							repaint();
						}
						break;
...
class RecentSwatchPanel2 extends SwatchPanel2 {
	protected void initValues() {
